...
public class BoardCreator_sabotage : MonoBehaviour
{
    ...
    {
        CellData_sabotage data = cell.GetComponent("CellData_sabotage") as CellData_sabotage;
    ...
    int[,] generate_unsolved_board(int[,] board){
        int n=Settings_sabotage.default_n;
        if(Settings_sabotage.difficulty==1)
            n=Settings_sabotage.easy_n;
        if(Settings_sabotage.difficulty==2)
            n=Settings_sabotage.medium_n;
        if(Settings_sabotage.difficulty==3)
            n=Settings_sabotage.hard_n;
    ...
    void spawn_board()
    {
        ...
        for (int i = 0; i < 9;i++) {
            for (int j = 0; j < 9;j++){
                GameObject cell = GameObject.Find("Cell"+i.ToString()+"_"+j.ToString());
                CellData_sabotage data = cell.GetComponent("CellData_sabotage") as CellData_sabotage;
