...
public class BoardCreator : MonoBehaviour
{
    ...
    int[] generate_board()
    {
        ...
        int[] boardd = new int[81] {6, 2, 5, 8, 4, 3, 7, 9, 1,7, 9, 1, 2, 6, 5, 4, 8, 3,4, 8, 3, 9, 7, 1, 6, 2, 5,8, 1, 4, 5, 9, 7, 2, 3, 6,2, 3, 6, 1, 8, 4, 9, 5, 7,9, 5, 7, 3, 2, 6, 8, 1, 4,5, 6, 9, 4, 3, 2, 1, 7, 8,3, 4, 2, 7, 1, 8, 5, 6, 9,1, 7, 8, 6, 5, 9, 3, 4, 2};
        return boardd;
    }
    ...
    void spawn_board()
    {
        ...
        for (int i = 0; i < 81;i++) {
            ...
            data.admin_place(board[i],solution_board[i],prefab(board[i]));
        }
